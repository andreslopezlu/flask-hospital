...
class Turn(db.Model):
    ...
    turn_state_id: Mapped[int] = mapped_column(db.Integer(unsigned=True), db.ForeignKey("turn_state.id"), nullable=True)
    ...
    admission: Mapped["Admission"] = relationship("Admission", back_populates="turn", lazy="joined", uselist=False)
