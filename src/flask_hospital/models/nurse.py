...
class Nurse(db.Model):
    ...
    def __repr__(self) -> str:
        return (
            f"Nurse (id={self.id}, name='{self.name}', lastname='{self.lastname}', "
            f"identification_number={self.identification_number}, "
            f"nurse_license_number={self.nurse_license_number}, "
    ...
    def to_dict(self) -> dict[str, str | int | float | bool | datetime | Identification | Gender | BloodType | None]:
        return {
            ...
            "nurse_license_number": self.nurse_license_number,
            "email": self.email,
